	...
	return (
		<main className="flex flex-1 flex-col items-center justify-center px-4 text-center">
			...
			<h1 className="mb-4 max-w-2xl text-4xl font-bold tracking-tight sm:text-5xl">
				Your own Heroku. <span className="text-[#325CEB]">One command.</span>
			</h1>

			<p className="mb-8 max-w-lg text-lg text-fd-muted-foreground">
				Atlas turns any Linux server into a production-ready platform. Developers write code — Atlas
				handles infrastructure, DNS, HTTPS, secrets, and deployments.
			</p>
			...
			<div className="mt-12 w-full max-w-xl rounded-lg border bg-fd-card p-4 text-left">
				<pre className="overflow-x-auto text-sm">
					<code>
						<span className="text-fd-muted-foreground">$</span> curl -fsSL
						https://atlas.codeatlas.com.br/install.sh | bash{"\n"}
						<span className="text-fd-muted-foreground">$</span> atlas login{"\n"}
						<span className="text-fd-muted-foreground">$</span> atlas infra setup --host
